              ...
              <div key={index} className="my-2">
                <div className="w-100">
                  <div className="row Black-div p-3 mb-4">
                    <div className="col-6 d-md-block d-lg-none">Title </div>
                    <div className="col-lg col-md-12">Here's the article</div>
                    <div className="col-6 d-md-block d-lg-none">Category </div>
